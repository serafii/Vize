...
const Reason: React.FC = () => {
  return (
    <motion.section
      className="w-full max-w-3xl mx-auto mt-20 mb-8 px-4 sm:px-6"
      initial={{
        opacity: 0,
        y: 20,
      }}
    ...
    >
      <div className="relative bg-surface rounded-2xl p-8 md:p-10 border border-white/5 overflow-hidden">
